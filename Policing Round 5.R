...
###From this point we're jumping over into HuggingFace like a silly boy!, That being said, we are going to focus on the work that was used in TextAnalysis.R, so this is just some code to clear up the workspace kk bestie?

###Ones Worth Keeping:filtereddata SentimentAnalysisPartyStyleV2, ValencePartyDF
rm(Balling_Data)
rm(BulkUCC438Regression)
rm(BulkUCC439Regression)
rm(CES)
rm(dfm_defaults)
rm(dfm_lsd)
rm(dfm_nostopwords)
rm(dfm_stemmed)
rm(doc_term_matrix)
rm(doc_term_matrix_defaults)
rm(FinalUni)
rm(group_term_matrix)
rm(group_term_matrix_step1)
rm(HypothesisFour)
rm(HypothesisOne)
rm(HypothesisFourLong)
rm(HypothesisTwo)
rm(HypothesisTwoPart2)
rm(HypothesisTwoGraph)
rm(HypothesisTwoTooGraph)
rm(HypothesisFourPolitical)
rm(HypothesisFourLong)
rm(HypothesisOne)
rm(HypothesisOneGraph)
rm(HypothesisFourPoliticalLong)
rm(HypothesisThree)
rm(HypothesisThreeGraph)
rm(IncomeRegression)
rm(IncomeRegressionPoliceCad)
rm(IncomeRegressionPoliceCall)
rm(IncomeRegressionPoliceThermo)
rm(IncomeRegression)
rm(MeanValenceDF)
rm(MultiRegressionDataFrame)
rm(my_tokens)
rm(my_tokens_defaults)
rm(NAOmittedMultiRegressionDataFrame)
rm(NegativeFiltered)
rm(NeutralFiltered)
rm(NewsconsumptionRegression)
rm(NewsconsumptionRegressionPoliceCad)
rm(NewsconsumptionRegressionPoliceCall)
rm(NewsconsumptionRegressionPoliceThermo)
rm(NewsStationPerception)
rm(NewsStationPerceptionPolitical)
rm(PartyRegression,PartyRegressionPoliceCad,PartyRegressionPoliceCall,PartyRegressionPoliceThermo)
rm(OpinionSentimentCount)
rm(OpinionSentimentCountExp)
rm(OpinionSentimentCountExpFiltered)
rm(OverallToBeBound)
rm(PoliceBulkThermoRegression)
rm(PositiveFiltered)
rm(PostLSDNotThatKindTokenizedOpi)
rm(PrimedThoughtRegression,PrimedThoughtRegressionPoliceCad,PrimedThoughtRegressionPoliceCall,PrimedThoughtRegressionPoliceThermo)
rm(PrimingThermometer)
rm(PrimingThermometerGraph)
rm(ProvenRelationship)
rm(RaceRegression,RaceRegressionPoliceCad,RaceRegressionPoliceCall,RaceRegressionPoliceThermo)
rm(sample_neg,sample_neu,sample_pos,Sample_Neg)
rm(SentimentAnalysis)
rm(SentimentAnalysisFinal)
rm(SentimentAnalysisFinalPartyStyle)
rm(temp_dfm)
rm(temp_tokens)
rm(ToBeBound)
rm(TokenizedOpi)
rm(ValencePartyFiltered)
rm(ValencePartygraph)
rm(ValencePartygraphFilt)
rm(ValencePartygraphFilt2)
rm(ValencePromptgraph)
rm(ValencePartyFiltered2)
RobertaLovesYou<-data.frame(Valence=ValencePartyDF$Valence,Party=ValencePartyDF$PID,Prompt=ValencePartyDF$Prompt,Thermo=ValencePartyDF$PoliceThermo,Words=SentimentAnalysisFinalPartyStyleV2$Text)
RobertaLovesYou<-mutate(RobertaLovesYou,ValenceAnswer=ifelse(ValencePartyDF$Valence<4&ValencePartyDF$Valence> -4, "Neutral",ifelse(ValencePartyDF$Valence>0,"Positive","Negative")))
RobertaLovesYou<-na.omit(RobertaLovesYou)
